...
* [in] liste : nom de la liste à initialiser.
* [in] taille : nombre de listes enrgesitrables.
* [out] liste : liste initialisée en tant que tableau dynamique.*/
...
* [in] liste_principale : liste de listes dans laquelle il faut ajouter la liste de mots.
* [in] liste_to_add : liste à ajouter dans la liste_principale.
* [out] liste_principale : liste de listes de mots actualisée avec la nouvelle liste de mots.*/
...
* [in] liste_principale : liste de listes de mots dans laquelle on ajoute les listes de mots.
* [out] liste_principale : liste de listes de mots actualisée avec les listes de mots entrées.*/
...
* [in] liste : liste de listes de mots dont la mémoire doit être libérée.
* [out] liste : liste de listes de mots désallouée en mémoire.*/
